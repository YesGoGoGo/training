from sys import argv; script, from_file, to_file = argv; input = open(from_file); indata = input.read(); output = open(to_file, 'w'); output.write(indata); print "Operation Complete.";
...
# open the from_file and bind it to input name
## 
...
# use the exist tool (?) to check if the to_file exists
### 
